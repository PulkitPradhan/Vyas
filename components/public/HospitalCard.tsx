      ...
      <div className="w-full md:w-64 flex flex-col gap-4 flex-shrink-0 border-t md:border-t-0 md:border-l border-ms-border pt-4 md:pt-0 md:pl-6">
        ...
        <div className="flex flex-col gap-2 mt-auto">
          ...
          <div className="flex gap-2">
            <button className="flex-1 bg-transparent border border-ms-border text-ms-textPrimary text-xs font-semibold py-2 rounded-ms-sm hover:border-brand hover:text-brand transition-all ms-press group-hover:scale-[1.01]">
